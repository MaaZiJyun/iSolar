...
"[project]/src/data/starProperties.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$starProperties$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/data/starProperties.ts [app-ssr] (ecmascript)");
...
function StarLifecycle() {
    ...
    const [userData, setUserData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(); // User data
    ...
    const [elapsedTime, setElapsedTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(""); // Dynamic timer
    ...
    const getStarProperties = (lifePercentage)=>{
        if (lifePercentage > 75) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$starProperties$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["starProperties"][0];
        } else if (lifePercentage > 50) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$starProperties$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["starProperties"][1];
        } else if (lifePercentage > 25) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$starProperties$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["starProperties"][2];
        } else if (lifePercentage > 1) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$starProperties$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["starProperties"][3];
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$starProperties$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["starProperties"][4];
        }
    };
...
//# sourceMappingURL=src_256415._.js.map